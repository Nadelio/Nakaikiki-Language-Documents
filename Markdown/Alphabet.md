...
- pronounced `/ˈjʌ/` when used *in* a word
- pronounced `/iː/` when used *alone*

`Kai`:
- means large, grand, big, strong, many, or long
- can be used to emphasize a word or phrase in a neutral or surprised way
  - `Kai Du Nakai!` = "You are small!" (neutral/surprised observation)
- pronounced `/kaɪ/`
...
`No`:
- tense letter, used to indicate future tense
- can use `Na` to make this mean past-tense: `Nano`
- pronounced `/noʊ/`

`Hi`:
- means place/area/to place
- pronounced `/hi/`

`Fu`:
- means fluid/liquid/separate
- pronounced `/fu/`

`Ru`:
- means touch/feel/texture
- pronounced `/ɹu/`

`La`:
- means speak/say/word
- pronounced `/lɑː/`
